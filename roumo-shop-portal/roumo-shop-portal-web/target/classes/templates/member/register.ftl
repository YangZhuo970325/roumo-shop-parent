    ...
    <div class="layui-container">
        ...
        <div class="house-banner layui-form">
            <a class="banner" href="index.html"> <img
                    src="../res/static/img/roumo_shop_logo.png" alt="柔陌商城">
            </a>
    ...
    <div class="layui-fulid" id="house-login">
        <div class="layui-form">
            ...
            <div class="layui-input-block login">
				...
				<input type="text" required lay-verify="required" value="${(registerVo.mobile)!''}"
            ...
            <div class="layui-input-block-weixinQRcode"
                ...
                <img alt="" src="../res/static/img/weixin_code.jpg">
